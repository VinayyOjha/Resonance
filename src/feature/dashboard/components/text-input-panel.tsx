...
import { COST_PER_UNIT, TEXT_MAX_LENGTH } from "@/feature/text-to-speech/data/constants";
...
export function TextInputPanel() {
  ...
  return (
    <div className="rounded-[22px] bg-linear-185 from-[#ff8ee3] from-15% via-[#57d7e0] via-40% to-[#dbf1f2] to-85% p-0.5 shadow-[0_0_0_4px_white] ">
        ...
        <div className="space-y-4 rounded-2xl bg-white p-4 drop-shadow-xs">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-muted-foreground">
              {text.length.toLocaleString()} / {TEXT_MAX_LENGTH.toLocaleString()} character
            </span>
          </div>
        </div>
